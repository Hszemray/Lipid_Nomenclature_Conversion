...
Many thanks to Alanah Grant-St James, Dana Hicks and any other contributors for providing the nomenclature key. 
...
To use the function, follow these steps
   ...
   # Call the function:
   Updated_Data <- Nomenclature_update(Data, method_version = "v4") # supported versions = "v2" or "v4"
